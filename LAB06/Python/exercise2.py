...
def exercise2c(time_param):
    ...
    for frq in frequencies:
        ...
        plt.plot(res_sin[:, 1], res_sin[:, 2], label="Frequency=%1.f[Hz]" % frq)
        plt.figure("2_c_state_plot_sine_frq")
        plt.plot(res_sin[:, 0], res_sin[:, 1], label="Frequency=%1.f[Hz]" % frq)
        plt.figure("2_c_phase_plot_rect_frq")
        plt.plot(res_rect[:, 1], res_rect[:, 2], label="Frequency=%1.f[Hz]" % frq)
        plt.figure("2_c_state_plot_rect_frq")
        plt.plot(res_rect[:, 0], res_rect[:, 1], label="Frequency=%1.f[Hz]" % frq)
    ...
    for amplitude in frequencies:
        ...
        plt.plot(res_sin[:, 1], res_sin[:, 2], label="Amplitude=%1.f" % amplitude)
        plt.figure("2_c_state_plot_sine_amp")
        plt.plot(res_sin[:, 0], res_sin[:, 1], label="Amplitude=%1.f" % amplitude)
        plt.figure("2_c_phase_plot_rect_amp")
        plt.plot(res_rect[:, 1], res_rect[:, 2], label="Amplitude=%1.f" % amplitude)
        plt.figure("2_c_state_plot_rect_amp")
        plt.plot(res_rect[:, 0], res_rect[:, 1], label="Amplitude=%1.f" % amplitude)
